...
use crate::relay::{netwatch::NetworkWatcher, outbox::RelayTransportDemand, NormRelayUrl};
...
pub(super) struct RelayConnectionRuntime {
    ...
    pub(super) network_watcher: NetworkWatcher,
}
...
impl RelayConnectionRuntime {
    pub(super) fn new(config: OutboxServiceConfig) -> Self {
        ...
        Self {
            ...
            multicast_ready_tx,
            multicast_ready_rx,
            network_watcher: NetworkWatcher::new(),
        }
    }
