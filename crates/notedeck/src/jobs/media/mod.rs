...
use crate::{
    jobs::{cache::JobComplete, types::JobId},
    Animation, Error, JobPackage, JobsCache, MediaJobKind, TextureState, TexturesCache,
};

pub type MediaJobs = JobsCache<MediaJobKind, MediaJobResult>;
