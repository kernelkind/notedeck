use crate::{
    ...
    ui::{
        ...
        AccountsView, PostReplyView, PostView, ProfileView, RelayView, ThreadView, TimelineView,
    },
    Damus,
};
...
pub fn render_nav(
    ...
    let drag_ids = 's: {
        ...
        let vertical_drag_id = get_drag_id(ui, scroll_id);
...
fn get_drag_id(ui: &egui::Ui, scroll_id: egui::Id) -> egui::Id {
